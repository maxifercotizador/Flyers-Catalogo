...
const GRUPOS = [
  ...
  { key: 'resortes',   label: "Resortes",                icono: "🌀", color: "#10b981",
    codigos: ["RES. LF","RES. LC","RES. LP","RES. LB","RES. LA","RES. COMP."] },
  ...
  { key: 'aluminio',   label: "Conexiones de Agua — Aluminio y Plásticas", icono: "🔧", color: "#06b6d4",
    codigos: ["CONEX. ALUM. 1","CONEX. ALUM. 2","Conex. Alum. L. Temp.","Conex. Alum. Mayor Rot.","CONC. PL","CONC. COMB. Red"] },
  { key: 'neumaticas', label: "Conexiones Neumáticas + Racord", icono: "💨", color: "#f97316",
    codigos: ["CON. NEU. + RAC.","CON. NEU. COMPL.","CON. NEU. NUEV.","CON. NEU.","RAC. GR.","RAC. CH.","RE-RC2-02","BRONCE","RE-RC1-01","RE-CNE-01"] },
  { key: 'perillas',   label: "Perillas de Cocina",      icono: "🎛️", color: "#ec4899",
    codigos: ["PER. COMP.","PER. 2","PER. 1"] },
  { key: 'terminales', label: "Terminales para Cable",   icono: "⚡", color: "#84cc16",
    codigos: ["TEM. COMP.","TERM. NU.","TERM. CH."] },
  { key: 'carbones',   label: "Carbones Eléctricos",     icono: "🔋", color: "#374151",
    codigos: ["CARB. COMPL.","CARB. 1","RE-CB1-01","RE-CB2-02"] },
  { key: 'otros',      label: "Otros",                   icono: "📦", color: "#9ca3af",
    codigos: ["TAP. CAR.","ABRA. GOMA","REGAT.","TOP. TAP. GOMA","ALEM.","INS.","TAR. ESTR.","RET. ARAN."] },
  { key: 'tuercas',    label: "Tuercas Rápidas / Tornillería / Remaches", icono: "🔩", color: "#7c3aed",
    codigos: ["TR Espec. + Torn.","Torn. Esp.","TR L. Compl.","TUER. RAP.","T. REM.+T. RAP.","TR IMP.","TER. REM."] },
  { key: 'bulones',    label: "Bulones Perforados / Uniones", icono: "🔩", color: "#dc2626",
    codigos: ["UN. ORIENT.","RE-UNO-01","RE-BPF-01"] },
  { key: 'esparragos', label: "Espárragos de Acero",     icono: "🪛", color: "#a16207",
    codigos: ["ESPARR.","RE-ESA-01"] },
  { key: 'arandelas',  label: "Arandelas",               icono: "🔘", color: "#8b5cf6",
    codigos: ["ARAND. COMP.","ARAND. CH.","ARAND. LP.","ARAN. CO-FI-AL","ARAND. INYEC."] },
  { key: 'espinas',    label: "Espinas Elásticas",       icono: "📏", color: "#0891b2",
    codigos: ["ESP. ELAS.","RE-EEL-01"] },
  { key: 'interrup',   label: "Interruptores y Pulsadores", icono: "💡", color: "#eab308",
    codigos: ["INTERR. PULSA.","RE-IP1-01","RE-IP2-02"] },
  { key: 'picosgas',   label: "Picos para Gas",          icono: "🔥", color: "#ea580c",
    codigos: ["INYEC. GAS ENV.","RE-PGS-01"] },
  { key: 'seeger',     label: "Anillos Seeger",          icono: "↔️", color: "#475569",
    codigos: ["SEEG.","RE-SEG-01"] },
];
...
const VERSION_REDUCIDA = {
  ...
  "CON. NEU. + RAC.": { piezas: 275, precio: 1190767 },
  ...
  "Torn. Esp.": { piezas: 315, precio: 368573 },
  "T. REM.+T. RAP.": { piezas: 332, precio: 279032 },
  ...
  "ARAND. COMP.": { piezas: 460, precio: 282471 },
